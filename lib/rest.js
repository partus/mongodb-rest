...
module.exports = function (app, config) {
    ...
    //     // if(req.params.db == "collectionapi") req.params.db = "meteor";
    //     req.originalUrl = req.originalUrl.replace("collectionapi", "meteor");
    //     next();
    // })
    //
    ...
    app.get(urlPrefix + '/:db', function (req, res) {
        if(req.params.db == "collectionapi") {
            console.log("db is collectionapi")
            req.params.db = "meteor";
        }
